...
import Raw from '../raw'
import {normalizeArr, addQueryContext} from '../helpers'
...
import { isBoolean, isNumber, isObject, isString } from '../util/is'
...
assign(Builder.prototype, {
  ...
  distinctOn() {
    const value = normalizeArr.apply(null, arguments);
    if (isEmpty(value)) {
  ...
  forUpdate() {
    ...
    this._single.lockTables = normalizeArr.apply(null, arguments);
    return this;
  },
